...
import useTank from '../../tanques/composables/useTanque'
...
/**
 *  Función que consulta `fetchDataEntriesTanks`  para obtener datos desde la API la información.
 ...
 */
const fetchDataEntriesTanks = async (dateToUse) => {
    try {
        const res = await fetchEntriesTanks(dateToUse)
                        ...
                        <div class="grid grid-cols-12 gap-4 p-2">
                            <div class="col-span-2">
                                <Datepicker v-model="date" :format-locale="es" locale="es" cancelText="Cancelar"
                                    ...
                                    :format="formatPicker" autoApply @update:model-value="fetchDataEntriesTanks(dateToUse)"
                                    :clearable="false" />
                            </div>
                        </div>
